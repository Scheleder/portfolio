...
<div class="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl shadow-xl p-8 md:p-12 transition-all duration-300 mb-10">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <?php
        $experiences = [
            ['logo' => 'gstech.png', 'company' => 'GSTECH', 'date' => 'jul/2024', 'role' => 'Cargo / Função', 'prof_dev' => 'Aprimoramento em novas tecnologias e projetos.', 'desc' => 'Descrição das atividades realizadas.'],
            ['logo' => 'boticario.png', 'company' => 'GRUPO BOTICÁRIO', 'date' => 'fev/2024 – abr/2026', 'role' => 'Técnico de Automação.', 'prof_dev' => 'Aprimoramento em manutenção e processos da indústria.', 'desc' => 'Manutenção de sistemas de automação industrial.'],
