...
@section('title', 'Scheleder - Formação')
...
<div class="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl shadow-xl p-8 md:p-12 transition-all duration-300">
    ...
    <div class="space-y-8">
        ...
        <div class="group flex flex-col md:flex-row items-start md:items-center gap-6 p-6 rounded-xl bg-white dark:bg-gray-700/50 shadow-md hover:bg-gray-50 dark:hover:bg-gray-700/80 transition-all duration-300 border border-gray-100 dark:border-gray-600 hover:border-gray-200 dark:hover:border-gray-500">
            <img src="{{ asset('img/estacio.png') }}" alt="logo" class="w-16 h-16 object-contain bg-white rounded-lg p-1 shadow-sm group-hover:scale-110 transition-transform duration-300">
            <div>
        ...
        <!-- Item 2 -->
        <div class="group flex flex-col md:flex-row items-start md:items-center gap-6 p-6 rounded-xl bg-white dark:bg-gray-700/50 shadow-md hover:bg-gray-50 dark:hover:bg-gray-700/80 transition-all duration-300 border border-gray-100 dark:border-gray-600 hover:border-gray-200 dark:hover:border-gray-500">
            <img src="{{ asset('img/senai.png') }}" alt="logo" class="w-16 h-16 object-contain bg-white rounded-lg p-1 shadow-sm group-hover:scale-110 transition-transform duration-300">
            <div>
        ...
        <!-- Item 3 -->
        <div class="group flex flex-col md:flex-row items-start md:items-center gap-6 p-6 rounded-xl bg-white dark:bg-gray-700/50 shadow-md hover:bg-gray-50 dark:hover:bg-gray-700/80 transition-all duration-300 border border-gray-100 dark:border-gray-600 hover:border-gray-200 dark:hover:border-gray-500">
            <img src="{{ asset('img/monitor.png') }}" alt="logo" class="w-16 h-16 object-contain bg-white rounded-lg p-1 shadow-sm group-hover:scale-110 transition-transform duration-300">
            <div>
