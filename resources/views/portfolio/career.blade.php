...
@section('title', 'Scheleder - Experiência')
...
<div class="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl shadow-xl p-8 md:p-12 transition-all duration-300 mb-10">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="group relative bg-white dark:bg-gray-700/50 shadow-md p-6 rounded-xl border border-gray-200 dark:border-gray-600 hover:shadow-xl hover:border-primary-light dark:hover:border-primary-dark transition-all duration-300 cursor-pointer transform hover:-translate-y-1" onclick="window.showCardModal(this)">
            ...
            <div class="flex items-center gap-4">
                <div class="w-14 h-14 bg-white rounded-lg p-1 shadow flex-shrink-0 flex items-center justify-center group-hover:scale-105 transition-transform duration-300">
                    <img src="{{ asset('img/' . $exp['logo']) }}" alt="logo" class="max-w-full max-h-full object-contain">
                </div>
                <div class="flex-1">
